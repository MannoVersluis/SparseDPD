...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=17,da_board_cnt=1,da_clkrst_cnt=10,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  design_1_axi_smc_1_0 axi_smc_1
       (.M00_AXI_araddr(axi_smc_1_M00_AXI_ARADDR),
        ...
        .aclk(processing_system7_0_FCLK_CLK0),
        .aresetn(proc_sys_reset_0_peripheral_aresetn));
  design_1_main_wrapper_0 main_wrapper
       (.clk(processing_system7_0_FCLK_CLK0),
        .m_out_axis_tdata(main_wrapper_m_out_axis_TDATA),
        .m_out_axis_tlast(main_wrapper_m_out_axis_TLAST),
        .m_out_axis_tready(main_wrapper_m_out_axis_TREADY),
        .m_out_axis_tvalid(main_wrapper_m_out_axis_TVALID),
        .resetn(proc_sys_reset_0_peripheral_aresetn),
        .s_inp_axis_tdata(axi_dma_0_M_AXIS_MM2S_TDATA),
        .s_inp_axis_tlast(axi_dma_0_M_AXIS_MM2S_TLAST),
        .s_inp_axis_tready(axi_dma_0_M_AXIS_MM2S_TREADY),
        .s_inp_axis_tstrb({1'b1,1'b1,1'b1,1'b1}),
        .s_inp_axis_tvalid(axi_dma_0_M_AXIS_MM2S_TVALID));
