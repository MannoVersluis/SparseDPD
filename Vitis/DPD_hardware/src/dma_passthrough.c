...
int dma_passthrough_rcv(dma_passthrough_t* p_dma_passthrough_inst)
{
		...
		int* ptr = p_dma_passthrough_inst->p_rcv_buf;
		xil_printf("Received: %d 	", *(ptr));
		xil_printf("Received: %d 	", *(ptr+1));
...
int dma_passthrough_snd(dma_passthrough_t* p_dma_passthrough_inst)
{
	...
	short* ptr = p_dma_passthrough_inst->p_snd_buf;
	xil_printf("Sent: %d 	", *(ptr));
	xil_printf("Sent: %d 	", *(ptr+1));
